...
export class Post extends React.Component<IPostProps, IPostState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="post-heading">
          <Translate contentKey="tertiaoculusApp.post.home.title">Posts</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="tertiaoculusApp.post.home.createLabel">Create new Post</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('imageUrl')}>
                    <Translate contentKey="tertiaoculusApp.post.imageUrl">Image Url</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('country')}>
                    <Translate contentKey="tertiaoculusApp.post.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('city')}>
                    <Translate contentKey="tertiaoculusApp.post.city">City</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('date')}>
                    <Translate contentKey="tertiaoculusApp.post.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {postList.map((post, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{post.city}</td>
                    <td>
                      <TextFormat type="date" value={post.date} format={APP_LOCAL_DATE_FORMAT} />
                    </td>
